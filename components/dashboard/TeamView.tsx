...
export function TeamView() {
  ...
  return (
    ...
    >
      {/* ── PODIUM ── */}
      <Card style={{ gridColumn: '1', display: 'flex', flexDirection: 'column' }} delay={0}>
        <div style={{ fontSize: 12, color: 'var(--muted)', marginBottom: 16, letterSpacing: 1, textTransform: 'uppercase' }}>
          Top 3 del Período
        </div>
        <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'center', gap: 12, flex: 1, paddingBottom: 8 }}>
      ...
      {/* ── TEAM STATS ── */}
      <Card style={{ gridColumn: '2' }} delay={0.1}>
      ...
      {/* ── FULL LEADERBOARD ── */}
      <Card style={{ gridColumn: '1 / 3' }} delay={0.15}>
      ...
      {/* ── TEAM CHART ── */}
      <Card style={{ gridColumn: '1 / 3' }} delay={0.2}>
        <div style={{ fontSize: 12, color: 'var(--muted)', marginBottom: 10, letterSpacing: 1, textTransform: 'uppercase' }}>
